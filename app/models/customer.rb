class Customer < ApplicationRecord
  ...
  # Проверка уникальности комбинации name, phone и email
  validates :name, uniqueness: { scope: [:phone, :email], message: "Клиент с таким именем, номером телефона и email уже существует" }
end
